...
def number_of_words_in_dictionary(word_1, word_2):
    ...
    if word_1.islower() and word_2.islower() and word_1 == word_2:
        print(f'Could not find {word_1} in dictionary.')
    elif word_1.islower() and word_2.islower() and word_1 != word_2:
        print(f'Could not find at least one of {word_1} and {word_2} in dictionary.')
    elif word_1.isupper() and word_2.islower() or word_1.islower() and word_2.isupper():
        print(f'Could not find at least one of {word_1} and {word_2} in dictionary.')
    elif word_1.isupper() and word_2.isupper():
        dictionary = []
        ...
        if word_1 == word_2:
            ...
            index_1 = dictionary.index(word_1)
            index_2 = dictionary.index(word_2)
            num = abs(index_1 - index_2) + 1
            print(f'Found {num} words between {word_1} and {word_2} in dictionary.')
