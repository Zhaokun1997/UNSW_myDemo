...
class DoublyLinkedList:
    ...
    def keep_every_second_element(self):
        ...
        #     node = self.head
        #     # (1, 2, 3)
        #     while node and node.next_node and node.next_node.next_node:
        #         node.next_node = node.next_node.next_node
        #         node.next_node.previous_node = node
        #         node = node.next_node
        #         self.tail = node
        #     else:
        #         if node and node.next_node and not node.next_node.next_node:
        #             self.tail = node
        #             node.next_node = None
        #         elif node and not node.next_node:
        #             self.tail = node
