...
def can_merge(string_1, string_2, string_3):
    if not string_1 and string_2 == string_3: # string_1 is empty and string_2 == string_3
        return True
    if not string_2 and string_1 == string_3:# string_2 is empty and string_1 == string_3
        return True
